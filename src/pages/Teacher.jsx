...
const Teacher = () => {
    ...
    try {
      if (modal) {
        const response = await fetch(
          `${process.env.REACT_APP_API_KEY}/api/auth/teacher`,
          {
            method: "POST",
            headers: {
        ...
        const response = await fetch(
          `${process.env.REACT_APP_API_KEY}/api/auth/teacher/${selectedTeacher._id}`,
          {
            method: "PUT",
            headers: {
              "Content-Type": "application/json",
  ...
  const del = async (elem) => {
    try {
      const response = await fetch(
        `${process.env.REACT_APP_API_KEY}/api/auth/teacher/${elem._id}`,
        {
          method: "DELETE",
          headers: {
            "Content-Type": "application/json",
                  ...
                  {filterTeacher.map((elem, id) => (
                    <tbody className="student_info" key={id}>
                      <tr className="table_data">
                        ...
                        <td className="action">
                          <div>
                            <VisibilityIcon onClick={() => teacModal(elem)} />
                          </div>
                          <div>
                  ...
                  <div className="student_input">
                    <div>
                      ...
                      <input
                        ...
                        autoComplete="off"
                        onChange={onChange}
                        value={editModal ? selectedTeacher.name : teacData.name}
                      />
                    </div>
                    <div>
                      ...
                      <input
                        ...
                        onChange={onChange}
                        value={
                          editModal ? selectedTeacher.subject : teacData.subject
                        }
                      />
                    </div>
                  </div>
                  <div className="student_input">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={onChange}
                        value={
                          editModal ? selectedTeacher.email : teacData.email
                        }
                      />
                    </div>
                  </div>
                  <div className="student_input">
                    <div>
                      ...
                      <input
                        ...
                        onChange={onChange}
                        value={
                          editModal ? selectedTeacher.phone : teacData.phone
                        }
                      />
                    </div>
                    {modal && (
            ...
            <div className="modal">
              ...
              >
                ...
                <div className="student_data">
                  <div>
                    <p>
                      <span>Name:</span> {selectedTeacher.name}
                    </p>
                  </div>
                  <div>
                    <p>
                      <span>Subject:</span> {selectedTeacher.subject}
                    </p>
                  </div>
                  <div>
                    <p>
                      <span>Subject code:</span> {selectedTeacher.subjectcode}
                    </p>
                  </div>
                  <div>
                    <p>
                      <span>Email:</span> {selectedTeacher.email}
                    </p>
                  </div>
                  <div>
                    <p>
                      <span>Phone:</span> {selectedTeacher.phone}
                    </p>
                  </div>
                </div>
              </div>
